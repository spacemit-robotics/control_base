...
artifact_dir="${SROBOTIS_TEST_ARTIFACT_DIR:-${SROBOTIS_OUTPUT_ROOT:-$PWD/output}/test-artifacts/components/control/base/${SROBOTIS_TEST_NAME:-chassis-error-paths}}"
log_dir="$artifact_dir/logs"
log_file="$log_dir/chassis_error_paths.log"
...

{
    ...
    "$build_dir/test_chassis_api_contract" errors
} | tee "$log_file"
